...
const ISLAND_CELLS = [
    0,1,2,6,8,9,10,17,18,16,61,62,63,53,54,55,45,46,47,
    5,13,14,15,7,21,22,23,56,57,58,48,49,50,40,41,42
]
...
const X4ExerciseV2 = () => {
    ...
    const viewBoundaries = SvgBoundaries.fromPoints(fieldCorners).addAbsoluteMargin(0.3)
    ...
    function isIslandCell(i) {
        return ISLAND_CELLS.includes(i)
    }
